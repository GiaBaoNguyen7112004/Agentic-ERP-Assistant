    ...
    <SheetPortal>
      ...
      >
        ...
        <SheetPrimitive.Description className="sr-only">
          A slide-over panel; close it to return to the chat.
        </SheetPrimitive.Description>
        {children}
        <SheetPrimitive.Close className="ring-offset-background focus:ring-2 data-[state=open]:bg-secondary absolute top-4 right-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:outline-hidden disabled:pointer-events-none">
          <X className="size-4" />
